...
5. Summary: items cleaned and their total size, hard-linked blocks counted once (as in the selector footer and confirm prompt) — reported as `moved to Trash` for trash moves, `freed` for permanent deletes
