...
devclean is a Go CLI tool that scans developer environments for reclaimable disk space (build artifacts, caches, dependencies, runtimes) across 7 ecosystems and provides safe cleanup.
